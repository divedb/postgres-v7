...
#ifndef RDBMS_CATALOG_PG_ATTRIBUTE_H_
#define RDBMS_CATALOG_PG_ATTRIBUTE_H_
...
CATALOG(pg_attribute) BOOTSTRAP {
  ...
  // 'e': Value can be stored in "secondary" relation (if relation has rellongrelid attached)
...
#define ATTRIBUTE_TUPLE_SIZE (offsetof(FormData_pg_attribute, atthasdef) + sizeof(char))
...
// pg_variable
//  this relation is modified by special purpose access
...
#endif  // RDBMS_CATALOG_PG_ATTRIBUTE_H_

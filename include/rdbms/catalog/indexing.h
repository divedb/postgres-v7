...
extern void CatalogIndexInsert(Relation* idescs, int nIndices, Relation heapRelation, HeapTuple heapTuple);
 ...
 */
extern HeapTuple AttributeRelidNumIndexScan(Relation heapRelation, Datum relid, Datum attnum);

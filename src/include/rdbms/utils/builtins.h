...
//
//===----------------------------------------------------------------------===//
#ifndef RDBMS_UTILS_BUILTINS_H_
#define RDBMS_UTILS_BUILTINS_H_

#include "rdbms/nodes/relation.h"
#include "rdbms/storage/itemptr.h"
#include "rdbms/utils/fmgr.h"
#include "rdbms/utils/numeric.h"
...
extern int name_cpy(Name n1, Name n2);
extern int name_strcpy(Name name, const char* str);
extern int name_strcmp(Name name, const char* str);
...
extern char* deparse_expression(Node* expr, List* dpcontext, bool forceprefix);
...
/* inet_net_ntop.c */
extern char* inet_net_ntop(int af, const void* src, int bits, char* dst,
                           size_t size);
extern char* inet_cidr_ntop(int af, const void* src, int bits, char* dst,
                            size_t size);

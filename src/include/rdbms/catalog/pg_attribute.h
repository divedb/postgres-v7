...
{ 1247, {"typname"},	   19, 0, NAME_DATA_LEN,	1, 0, -1, -1, '\0', 'p', '\0', 'i', '\0', '\0' }, \
...
DATA(insert OID = 0 ( 1247 typname			19 0 NAME_DATA_LEN   1 0 -1 -1 f p f i f f));
 ...
 * ----------------
 */
DATA(insert OID = 0 ( 1262 datname			19 0 NAME_DATA_LEN   1 0 -1 -1 f p f i f f));
...
{ 1255, {"proname"},			19, 0, NAME_DATA_LEN,  1, 0, -1, -1, '\0', 'p', '\0', 'i', '\0', '\0' }, \
...
DATA(insert OID = 0 ( 1255 proname			19 0 NAME_DATA_LEN   1 0 -1 -1 f p f i f f));
 ...
 * ----------------
 */
DATA(insert OID = 0 ( 1260 usename			19	0 NAME_DATA_LEN	1 0 -1 -1 f p f i f f));
 ...
 * ----------------
 */
DATA(insert OID = 0 ( 1261 groname			19 0 NAME_DATA_LEN  1 0 -1 -1 f p f i f f));
...
{ 1249, {"attname"},	  19, 0, NAME_DATA_LEN,	2, 0, -1, -1, '\0', 'p', '\0', 'i', '\0', '\0' }, \
...
DATA(insert OID = 0 ( 1249 attname			19 0 NAME_DATA_LEN  2 0 -1 -1 f p f i f f));
...
{ 1259, {"relname"},	   19, 0, NAME_DATA_LEN,	1, 0, -1, -1, '\0', 'p', '\0', 'i', '\0', '\0' }, \
...
DATA(insert OID = 0 ( 1259 relname			19 0 NAME_DATA_LEN   1 0 -1 -1 f p f i f f));
...
DATA(insert OID = 0 ( 1216 rcname			19 0  NAME_DATA_LEN  2 0 -1 -1 f p f i f f));
...
DATA(insert OID = 0 ( 1219 tgname			19 0  NAME_DATA_LEN  2 0 -1 -1 f p f i f f));
...
DATA(insert OID = 0 ( 1219 tgconstrname		19 0  NAME_DATA_LEN  7 0 -1 -1 f p f i f f));

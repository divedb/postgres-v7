...
//
//===----------------------------------------------------------------------===//
#ifndef RDBMS_CATALOG_AM_H_
#define RDBMS_CATALOG_AM_H_
...
CATALOG(pg_am) {
  ...
  int2 amstrategies;       // total NUMBER of strategies by which we can traverse/search this AM
